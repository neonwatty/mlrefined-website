...
- Actual image: `.limner/runs/2026-06-21T213233501Z-uh9edw/captures/reference.png`
...
- Actual: not_applicable; final URL: `http://127.0.0.1:53274/`; requested: none
...
- Actual: 14 visible text block(s) shown.
  - "Machine Learning Refined VISUAL LEARNING LAB Chapters Visual Gallery Notebooks Exercises GitHub Open resources INTERACTIVE COMPANIONS TO..." <main> @ 0,0 1440x1356
...
- `actualImageSha256`: `79a61ffb4207ae6a8b9f9479876724b0692387d491b95b7adf12541434ae2656`
...
- `.limner/runs/2026-06-21T213233501Z-uh9edw/agent-comparison/agent-response.schema.json`

Minimal valid response template:

- `.limner/runs/2026-06-21T213233501Z-uh9edw/agent-comparison/agent-response.minimal.json`

Submit valid JSON through Limner's local SQLite ledger:

- `limner loop response submit --trajectory traj_8a3e81be4482dbc4 --from-run 2026-06-21T213233501Z-uh9edw --file <response.json>`
