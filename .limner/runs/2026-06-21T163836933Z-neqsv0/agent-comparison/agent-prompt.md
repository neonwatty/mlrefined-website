...
- Actual image: `.limner/runs/2026-06-21T163836933Z-neqsv0/captures/reference.png`
...
- `actualImageSha256`: `590582638768792b05bf75c3279c78caa84e990b07dcd29f9010db6fa8d626a5`
...
- `.limner/runs/2026-06-21T163836933Z-neqsv0/agent-comparison/agent-response.schema.json`

Minimal valid response template:

- `.limner/runs/2026-06-21T163836933Z-neqsv0/agent-comparison/agent-response.minimal.json`

Submit valid JSON through Limner's local SQLite ledger:

- `limner loop response submit --trajectory traj_8a3e81be4482dbc4 --from-run 2026-06-21T163836933Z-neqsv0 --file <response.json>`
