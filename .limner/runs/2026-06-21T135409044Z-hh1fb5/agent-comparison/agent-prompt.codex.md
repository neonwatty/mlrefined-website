...
- Actual image: `.limner/runs/2026-06-21T135409044Z-hh1fb5/captures/reference.png`
...
- `.limner/runs/2026-06-21T135409044Z-hh1fb5/agent-comparison/agent-response.schema.json`

Minimal valid response template:

- `.limner/runs/2026-06-21T135409044Z-hh1fb5/agent-comparison/agent-response.minimal.json`

Submit valid JSON through Limner's local SQLite ledger:

- `limner loop response submit --trajectory traj_81224d1d0bec1a4f --from-run 2026-06-21T135409044Z-hh1fb5 --file <response.json>`
