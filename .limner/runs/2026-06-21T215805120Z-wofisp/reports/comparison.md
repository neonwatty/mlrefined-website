...
- Reference screenshot: `.limner/runs/2026-06-21T215805120Z-wofisp/captures/reference.png`
- Side-by-side: `.limner/runs/2026-06-21T215805120Z-wofisp/captures/side-by-side.png`


- Agent comparison prompt: `.limner/runs/2026-06-21T215805120Z-wofisp/agent-comparison/agent-prompt.md`
- Codex comparison prompt: `.limner/runs/2026-06-21T215805120Z-wofisp/agent-comparison/agent-prompt.codex.md`
- Claude comparison prompt: `.limner/runs/2026-06-21T215805120Z-wofisp/agent-comparison/agent-prompt.claude.md`
- Agent comparison schema: `.limner/runs/2026-06-21T215805120Z-wofisp/agent-comparison/agent-response.schema.json`
- Minimal response template: `.limner/runs/2026-06-21T215805120Z-wofisp/agent-comparison/agent-response.minimal.json`
...
- Actual: not_applicable; final URL: `http://127.0.0.1:55960/`; requested: none
