...
- Actual image: `.limner/runs/2026-06-21T215811133Z-vmzils/captures/reference.png`
...
- `actualImageSha256`: `a4f020390997d886c736beab2ea50447f954c721c4f73d6b23d12ef4f97e4a01`
...
- `.limner/runs/2026-06-21T215811133Z-vmzils/agent-comparison/agent-response.schema.json`

Minimal valid response template:

- `.limner/runs/2026-06-21T215811133Z-vmzils/agent-comparison/agent-response.minimal.json`

Submit valid JSON through Limner's local SQLite ledger:

- `limner loop response submit --trajectory traj_81224d1d0bec1a4f --from-run 2026-06-21T215811133Z-vmzils --file <response.json>`
