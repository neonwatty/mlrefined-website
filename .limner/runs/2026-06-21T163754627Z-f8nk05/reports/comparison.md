...
- Reference screenshot: `.limner/runs/2026-06-21T163754627Z-f8nk05/captures/reference.png`
- Side-by-side: `.limner/runs/2026-06-21T163754627Z-f8nk05/captures/side-by-side.png`


- Agent comparison prompt: `.limner/runs/2026-06-21T163754627Z-f8nk05/agent-comparison/agent-prompt.md`
- Codex comparison prompt: `.limner/runs/2026-06-21T163754627Z-f8nk05/agent-comparison/agent-prompt.codex.md`
- Claude comparison prompt: `.limner/runs/2026-06-21T163754627Z-f8nk05/agent-comparison/agent-prompt.claude.md`
- Agent comparison schema: `.limner/runs/2026-06-21T163754627Z-f8nk05/agent-comparison/agent-response.schema.json`
- Minimal response template: `.limner/runs/2026-06-21T163754627Z-f8nk05/agent-comparison/agent-response.minimal.json`
...
- Actual: not_applicable; final URL: `http://127.0.0.1:49956/`; requested: none
