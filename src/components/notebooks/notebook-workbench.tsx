  ...
  return (
    <div className="mt-3 grid gap-3">
      <section className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_360px]">
        <div className="grid gap-3 rounded-lg border border-[#ddcfad] bg-[#fffdf8]/95 p-3 shadow-xl shadow-[#071326]/10 lg:grid-cols-[minmax(300px,0.9fr)_minmax(340px,1.1fr)]">
          ...
          <Image
            className="h-[230px] w-full rounded-md border border-[#d9e2ec] bg-white object-contain p-3"
