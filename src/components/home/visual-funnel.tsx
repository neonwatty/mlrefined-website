...
export function VisualFunnel() {
  return (
    <section className="mx-auto my-5 w-[min(1480px,calc(100%_-_24px))] rounded-lg border border-[#ddcfad] bg-[#fffdf8]/90 p-4 shadow-xl shadow-[#071326]/10 sm:w-[min(1480px,calc(100%_-_48px))] md:p-6">
