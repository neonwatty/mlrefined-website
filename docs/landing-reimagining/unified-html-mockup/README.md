...
- Home visual funnel combines the curated static figure spotlight, Colab notebook GIF previews, and feature-learning figure gallery into one section; figure clicks inspect/zoom images, explicit buttons route to chapter resources, and GIF clicks route into the Notebooks workbench.
