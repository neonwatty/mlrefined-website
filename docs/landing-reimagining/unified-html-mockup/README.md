...
- Home visual funnel combines the curated static figure spotlight, animated notebook GIF previews, and feature-learning figure gallery into one section; figure clicks route to chapter packages and GIF clicks route into the Notebooks workbench.
...
- Chapter-by-chapter static figure atlas with source figure links and requisite chapter-note links.
- Non-destructive CSS `MLR` watermark overlays on displayed static book figures.
- Chapters removes the search bar, learning-goal/resource-type filter controls, and right-side selected-widget column; it now centers on the selected chapter package and scan-first chapter list.
...
- Additional feature-learning gallery figures copied from `machine-learning-refined-notes-assets`: `Figure_11_17.png`, `Figure_11_32.png`, `Figure_11_35.png`, `Figure_11_38.png`, `Figure_11_48.png`, `Figure_11_50.png`, `Figure_11_51.png`, and Ch. 7 `multiclass_histogram.png`.
